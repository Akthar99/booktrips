    ...
    return (
        <div className="mx-auto w-[min(760px,calc(100%-2rem))] py-7 pb-14">
            ...
            <p className="mt-3 mb-5 text-muted">
                BookTrips is for Sri Lankan weekends: a day out from Colombo, a camping night in Ella, a villa
                for the family, a jeep at Yala. Hosts list packages. You reserve with a verified email. You pay
            ...
            <p className="text-[15px] text-[#3f3f46]">
                Create an account, verify the email we send, then reserve. Your booking code is the only thing
                the host needs.
            </p>
            <h3 className="mt-5 text-xl">Hotels, villas &amp; operators</h3>
            <p className="text-[15px] text-[#3f3f46]">
                Register the business, add a package with photos, price and what’s included. Confirmed bookings
