...
const AdminOverview: InertiaComponent<OverviewProps> = ({
    ...
    const cards: Array<[string, string | number, string | null]> = [
        ...
        [
            'Partners',
            stats.partners,
            stats.partners_pending ? `${stats.partners_pending} pending` : null,
        ],
        ...
        [
            ...
            stats.receipts_pending
                ? `${stats.receipts_pending} receipts`
                : null,
        ],
    ];
    ...
    const attentionItems: Array<[string, number, string]> = [
        [
            'Reports ready for a verdict',
            attention.disputes_ready,
            '/admin/disputes',
        ],
        [
            'Reports waiting on a reply',
            attention.disputes_awaiting,
            '/admin/disputes?status=open',
        ],
        [
            'Support requests to answer',
            attention.tickets_waiting,
            '/admin/support?status=awaiting_admin',
        ],
    ...
    return (
        <div className="mx-auto w-[min(1180px,calc(100%-2rem))] py-7 pb-14">
            ...
            <p className="text-muted">
                Operations console — users, properties, reservations, money.
            </p>
            <Tabs items={ADMIN_TABS} />
            <h2 className="mb-3 text-2xl">Overview</h2>
            <p className="text-muted mb-4">
                What needs attention across BookTrips — the same ops view a
                booking platform uses.
            </p>
            ...
            <div className="mb-8 grid gap-5 lg:grid-cols-[1fr_360px]">
                <section className="border-line rounded-2xl border bg-white p-5">
                    ...
                    <p className="text-muted mb-3 text-[13px]">
                        Everything below is waiting on the BookTrips team right
                        now.
                    </p>
                        ...
                        {attentionItems.map(([label, count, href]) => (
                            <Link
                                ...
                                className={cn(
                                    ...
                                    count > 0
                                        ? 'hover:border-warn border-orange-200 bg-orange-50'
                    ...
                    <dl className="grid grid-cols-2 gap-3 text-sm">
                        {[
                            ...
                            <div key={label as string}>
                                ...
                                <dd className="text-brand-900 font-bold">
                                    {value}
                                </dd>
                            </div>
                        ))}
            ...
            <div className="mb-8 grid gap-5 lg:grid-cols-2">
                <section className="border-line rounded-2xl border bg-white p-5">
                    ...
                    <Link
                        className="text-brand-800 mt-3 inline-block text-[13px] font-bold"
                        href="/admin/payments"
                    >
                        Open finance →
                    </Link>
                ...
                <section className="border-line rounded-2xl border bg-white p-5">
                    ...
                    <p className="text-muted mb-3 text-[13px]">
                        Bookings created and GMV confirmed.
                    </p>
                    <div className="flex h-32 items-end gap-2">
                        {months.map((month) => (
                            ...
                            >
                                <div
                                    className="bg-brand-700/80 w-full rounded-t-md"
                                    style={{
                                        height: `${Math.max(6, (month.gmv_lkr / maxGmv) * 100)}%`,
                                    }}
                    ...
                    <div className="text-muted mt-2 flex justify-between text-[12px]">
                        <span>
                            {months.reduce(
            ...
            <section className="border-line rounded-2xl border bg-white">
                <h3 className="border-line border-b px-4 py-3 text-xl">
                    Top partners by completed business
                </h3>
                        ...
                        <tbody>
                            {topPartners.map((partner) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2.5">
                                        {lkr(partner.completed_gmv_lkr)}
                                    </td>
                                    <td className="px-4 py-2.5">
                                        {lkr(partner.invoiced_lkr)}
                                    </td>
                                    <td className="px-4 py-2.5">
                                        {partner.strikes}
                                    </td>
